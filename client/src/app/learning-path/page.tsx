...
const LearningPathPage = () => {
  ...
  return (
    <>
      ...
      <div className="mt-10 flex items-center justify-center bg-class-tertiary">
      ...
      {/* Roadmap */}
      <div className="mt-20 flex flex-col lg:px-0 sm:px-10 px-5 items-center">
        <div className="max-w-6xl mx-auto">
          <div className="w-1/2 gap-3">
            ...
            <p className="text-class-primary mt-3">
              ...
              Voluptates ullam animi rerum aliquam corrupti deserunt provident,
              ducimus quis
            </p>
          </div>
        </div>
